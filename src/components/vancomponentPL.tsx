          ...
          >
            ...
            >
              <div className="w-full flex items-center">
                ...
                <p className="text-center font-normal pl-[5px]">transfer do 8 osób</p>
              </div>
              <div className="w-full flex  items-center">
                <FaSuitcaseRolling className="text-yellow-500" />
                <p className=" text-center pl-[5px]">do 7 średnich walizek</p>
              </div>
              <div className="w-full flex  items-center">
            ...
            >
              ...
              <div className="bg-white w-full flex justify-end">
                ...
                >
                  {router.query.cartype !== "van" && <p>Wybierz ten model</p>}
                  {router.query.cartype === "van" && <p>Wybrany model</p>}
                </div>
              </div>
            </div>
          </div>
